...
*/
// RGBmatrixPanel2: Renamed by Ryo Ishigaki
...
// be specified as any pin within a specific PORT register stated below.
 ...
 #define DATADIR  DDRA
 #define SCLKPORT PORTC // Modified for Arduino Mega 2560 by Ryo Ishigaki
...
// multiple RGBmatrixPanel2 instances.  The solution at present is to
...
static RGBmatrixPanel2 *activePanel = NULL;

// Code common to both the 16x32 and 32x32 constructors:
void RGBmatrixPanel2::init(uint8_t rows, uint8_t a, uint8_t b, uint8_t c,
...
RGBmatrixPanel2::RGBmatrixPanel2(
...
void RGBmatrixPanel2::begin(void) {
...
// Original RGBmatrixPanel2 library used 3/3/3 color.  Later version used
...
uint16_t RGBmatrixPanel2::Color333(uint8_t r, uint8_t g, uint8_t b) {
  // RRRrrGGGgggBBBbb
...
uint16_t RGBmatrixPanel2::Color444(uint8_t r, uint8_t g, uint8_t b) {
  // RRRRrGGGGggBBBBb
...
uint16_t RGBmatrixPanel2::Color888(uint8_t r, uint8_t g, uint8_t b) {
  return ((r & 0xF8) << 11) | ((g & 0xFC) << 5) | (b >> 3);
}

// 8/8/8 -> gamma -> 5/6/5
uint16_t RGBmatrixPanel2::Color888(
...
uint16_t RGBmatrixPanel2::ColorHSV(
...
void RGBmatrixPanel2::drawPixel(int16_t x, int16_t y, uint16_t c) {
...
void RGBmatrixPanel2::fillScreen(uint16_t c) {
...
uint8_t *RGBmatrixPanel2::backBuffer() {
...
void RGBmatrixPanel2::swapBuffers(boolean copy) {
...
void RGBmatrixPanel2::dumpMatrix(void) {
...
void RGBmatrixPanel2::updateDisplay(void) {
